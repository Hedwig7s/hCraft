...
namespace hCraft.MapConversion {
    /// <summary> An enumeration of map formats supported by hCraft. </summary>
    public enum MapFormat {
        /// <summary> Unidentified map. </summary>
        Unknown,

        /// <summary> Obsolete map format previously used by hCraft before release 0.500 </summary>
        FCMv2,

        /// <summary> Obsolete map format previously used by hCraft 0.500-0.6xx </summary>
        FCMv3,
