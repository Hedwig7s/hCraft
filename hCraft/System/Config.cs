...
namespace hCraft {
    ...
    /// See http://www.hCraft.net/wiki/Config_version_history for format history. </summary>
    public static class Config {
        /// <summary>  Supported version of the Minecraft classic protocol. </summary>
        public const int ProtocolVersion = 7;

        /// <summary> Latest version of config.xml available at the time of building this copy of hCraft.
        ...
        const string ConfigXmlRootName = "hCraftConfig";
            ...
            if( fromFile ) {
                ...
                if( attr != null && Int32.TryParse( attr.Value, out version ) ) {
                    if( version < LowestSupportedVersion ) {
                        ...
                        Logger.Log( LogType.Warning,
                                    "Config.Load: Your config.xml was made for a different version of hCraft. " +
        ...
        static void LoadLogOptions( [NotNull] XContainer el, [NotNull] IList<bool> list ) {
            ...
            // for compatibility with hCraft 0.631 and earlier
