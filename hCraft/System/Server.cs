...
using hCraft.AutoRank;
using hCraft.Drawing;
using hCraft.Events;
...
namespace hCraft {
    /// <summary> Core of an hCraft server. Manages startup/shutdown, online player
    ...
    public static partial class Server {
        ...
        /// <summary> Produces a string containing all recognized arguments that were set/passed to this instance of hCraft. </summary>
        ...
        /// <summary> Produces a list of arguments that were passed to this instance of hCraft. </summary>
        ...
        public static void InitLibrary( [NotNull] IEnumerable<string> rawArgs ) {
            ...
            if( libraryInitialized ) {
                throw new InvalidOperationException( "hCraft library is already initialized" );
            }
        ...
        public static void InitServer() {
            ...
            if( Updater.CurrentRelease.IsFlagged( ReleaseFlags.Dev ) ) {
                Logger.Log( LogType.Warning,
                            "You are using an unreleased developer version of hCraft. " +
                            "Do not use this version unless you are ready to deal with bugs and potential data loss. " +
                            "Consider using the latest stable version instead, available from www.hCraft.net" );
            }
            ...
            File.Delete( "hCraftUpdater.exe" ); // pre-0.600
#endif
        ...
        static void ShutdownNow( [NotNull] ShutdownParams shutdownParams ) {
            ...
            try {
                ...
                Logger.LogAndReportCrash( "Error in Server.Shutdown", "hCraft", ex, true );
            }
#endif
        }
        ...
        public static void BackupData() {
            ...
            using( FileStream fs = File.Create( backupFileName ) ) {
                string fileComment = String.Format( "Backup of hCraft data for server \"{0}\", saved on {1}",
