...
#pragma warning restore 1591
        ...
        /// Both standard (0-F) and hCraft-specific (H, I, M, P, R, S, W, and Y) color codes are accepted. 
        /// Assigned (standard) colors are substituted for hCraft-specific color codes. </summary>
        ...
        /// Does not recognize hCraft-specific color codes. </summary>
        ...
        /// Both standard (0-F) and hCraft-specific (H, I, M, P, R, S, W, and Y) color codes are accepted. </summary>
        ...
        /// <summary> Substitutes all hCraft-specific ampersand color codes (like &amp;S/Color.Sys)
        ...
        /// Removes all ampersand-character sequences, including standard, hCraft-specific color codes, and newline codes.
