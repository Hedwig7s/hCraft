...
namespace hCraft {
    /// <summary> Contains hCraft path settings, and some filesystem-related utilities. </summary>
    public static class Paths {
        ...
        /// <summary> Whether hCraft should parse ConfigKey.MapPath when loading config.xml
        ...
        /// <summary> Working path (default: whatever directory hCraft.dll is located in)
        ...
        public const string DataBackupFileNameFormat = "hCraftData_{0:yyyyMMdd'_'HH'-'mm'-'ss}.zip";
        ...
        public static bool TestDirectory( [NotNull] string pathLabel, [NotNull] string path, bool checkForWriteAccess ) {
            ...
            try {
                ...
                if( checkForWriteAccess ) {
                    string randomFileName = Path.Combine( info.FullName, "hCraft_write_test_" + Guid.NewGuid() );
        ...
        /// Protected file names include all hCraft binaries, configuration files, and data files. </summary>
        /// <param name="fileName"> File name/path to check. </param>
