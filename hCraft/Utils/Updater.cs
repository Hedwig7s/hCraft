...
namespace hCraft {
    ...
    public static class Updater {
        ...
        /// Defaults to "hCraft" + VersionString of the current release. </summary>
        public static string UserAgent { get; set; }

        /// <summary> The latest stable branch/version of hCraft. </summary>
        public const string LatestStable = "0.644_r2327";

        /// <summary> Url to update hCraft from. Use "{0}" as a placeholder for CurrentRelease.Version.Revision </summary>
        public static string UpdateUri { get; set; }


        static Updater() {
            UserAgent = "hCraft " + CurrentRelease.VersionString;
            UpdateCheckTimeout = TimeSpan.FromMilliseconds( 4000 );
            UpdateUri = "http://www.hCraft.net/UpdateCheck.php?r={0}";
        }
        ...
        /// <summary> Checks hCraft.net for updated versions of hCraft. </summary>
        public static UpdaterResult CheckForUpdates() {
            ...
            Logger.Log( LogType.SystemActivity, "Checking for hCraft updates..." );
            try {
        ...
        /// <summary> Occurs when hCraft is about to check for updates (cancelable).
        /// The update Url may be overridden. </summary>
        public static event EventHandler<CheckingForUpdatesEventArgs> CheckingForUpdates;


        /// <summary> Occurs when hCraft has just checked for updates. </summary>
    ...
    /// <summary> Used to describe a particular release version of hCraft. Includes date released, version </summary>
